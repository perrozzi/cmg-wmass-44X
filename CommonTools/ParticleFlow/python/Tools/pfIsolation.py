...
def _loadPFBRECO(process):
    ...
    if _PFBRECO_loaded is False: 
        ...
        process.pfPhotonIsolationSequence.remove( process.pfPhotonIsoDepositsSequence )
        process.pfPhotonIsolationSequence.remove( process.pfPhotonIsolationFromDepositsSequence )
